...
public class DeviceList extends AppCompatActivity implements  View.OnClickListener  , NavigationView.OnNavigationItemSelectedListener
{
    ...
    ****************************************************************************************/
    ...
    private TextView tempShow,skinTemp2Show,heaterOutput,timerShow,setSkinTemp;
    private int tempValue;
    private String tempValueString;
    private int skinTemp2;
 ...
 ***************************************************************************************/
        ...
        ********************************************************************************************/
        ...
        setHumDisplay = findViewById(R.id.setSkinTemp);
    ...
    private String convertStringToHex(String string)
    {
        ...
        if(arrayHex[4]!=null) {
           // Long num1,num2,num3;
            ...
            int num1 = (Integer.parseInt(arrayHex[4], 16));
            int num2 = (Integer.parseInt(arrayHex[5], 16));
            int num6 = (Integer.parseInt(arrayHex[6], 16));
            int num7 = (Integer.parseInt(arrayHex[7], 16));
            int num8 = (Integer.parseInt(arrayHex[8], 16));
            int num9 = (Integer.parseInt(arrayHex[9], 16));

            int num12 = (Integer.parseInt(arrayHex[12], 16));
            int num13 = (Integer.parseInt(arrayHex[13], 16));

            tempValue = (num1 << 8) | (num2);
            float tempValueFloat = (float) tempValue / 10;
            tempValueString = String.valueOf(tempValueFloat);


            skinTemp2 = (num6 << 8) | (num7);
            float skinTemp2Float = (float) skinTemp2 / 10;
            skinTemp2String = String.valueOf(skinTemp2Float);

            float heaterOutputFloat = (float) num9;
            heaterOutputString  = String.valueOf(heaterOutputFloat);

            float timerFloat = (float) num8;
            timerShowString = String.valueOf(timerFloat);


            int setSkinTemp = (num12 << 8) | (num13);
           // float setSkinTempFloat = (float) setSkinTemp ;
            float setSkinTempFloat = (float) setSkinTemp / 10;
            setSkinTempString = String.valueOf(setSkinTempFloat);

            Log.i("logging", Arrays.toString(arrayHex) +" "+setSkinTempString);
        }
