...
package com.crgb.clock.mpchartEample;
...
import com.crgb.clock.DataModel;
import com.crgb.clock.DatabaseHandler;
import com.crgb.clock.R;
import com.crgb.clock.mpchart.DemoBase;
...
public class RealtimeLineActivity extends DemoBase
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xl.setValueFormatter (new ValueFormatter() {
            ...
            public String getFormattedValue (float value, Entry entry, int dataSetIndex,
                ...
                String s = "low temperature" + decimalFormat.format (value);
                return s;
            }
        });
...
//                                    dataModel.setAirTempValue(b.getAirtTempData());
                                ...
                                //    dbHandler.AddData(dataModel);
                                     HashMap<String,String> xAxisValues= dbHandler.GetInfantData();
