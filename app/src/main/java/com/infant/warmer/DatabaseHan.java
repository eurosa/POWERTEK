...
public class DatabaseHan extends SQLiteOpenHelper {
    ...
    public DatabaseHan(Context context) {
    ...
    public DatabaseHan(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
